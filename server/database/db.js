...
//     // const URL = `mongodb+srv://<vyshchinnu>:<123456789>@cluster0.sxivp.mongodb.net/`
...
const Connection = async () => {
    // const username = process.env.MONGODB_USERNAME;  // Your MongoDB username
    // const password = process.env.MONGODB_PASSWORD;  // Your MongoDB password
    // const URL = `mongodb+srv://${username}:${password}@cluster0.sxivp.mongodb.net/ECOMMERCE?retryWrites=true&w=majority`;
    const URL = `mongodb+srv://vyshchinnu:Chinni@123@cluster0.sxivp.mongodb.net/`;
